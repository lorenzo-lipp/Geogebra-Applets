...
/* {Segmento((-2.5, -6), (-2.5, 0.5)), Segmento((-2.5, 0.5), (8, 0.5)), Segmento((-2.5, -6), (8, -6)), Segmento((8, 0.5), (8, -2)), Segmento((8, -3.5), (8, -6))} */
...
function colide(oldPosition, direction) {
    ...
    if (direction === "right") newPosition.x += game.size / 2;
        ...
        if (isInPosition("Forma3", 19, 2)) return true;
    } else {
        newPosition.y -= game.size / 2;
        if (isInPosition("Forma3", 19, 5)) return true;
    }
    ...
    if (newPosition.x === xWall && (newPosition.y >= game.start.y - 5 * game.size || newPosition.y <= game.end.y + 5 * game.size)) return true;
...
function check() {
    ...
    points.forEach(p => p.x + offsetX < minX ? minX = p.x + offsetX : null);

    if (minX > game.start.x + (game.width - 5) * game.size) {
...
game.shapes = {
    "Forma1": {
        ...
        position: { x: 2, y: 2 },
        points: [
            midPoint([game.size, -game.size], [0, -game.size]),
            ...
            midPoint([game.size * 2, -game.size * 3], [game.size * 3, -game.size * 3]),
            ...
            midPoint([game.size * 2, -game.size * 3], [game.size, -game.size * 2]),
            midPoint([game.size, -game.size * 2], [0, -game.size]),
            midPoint([0, -game.size], [-game.size, -game.size * 2]),
            midPoint([0, -game.size * 2], [-game.size, -game.size * 3])
        ],
        visible: true
    },
    "Forma2": {
        ...
        points: [
            ...
            midPoint([game.size, -game.size], [game.size * 2, -game.size * 2]),
            midPoint([game.size * 2, -game.size * 2], [game.size * 3, -game.size * 3]),
            midPoint([game.size * 2, -game.size * 3], [game.size, -game.size * 4]),
            midPoint([game.size, -game.size * 4], [0, -game.size * 5]),
            midPoint([game.size * 2, -game.size * 2], [game.size * 2, -game.size * 3]),
            midPoint([game.size, -game.size], [game.size, -game.size * 2]),
    ...
    "Forma4": {
        ...
        points: [
            ...
            midPoint([0, -game.size * 3], [0, -game.size * 4]),
            midPoint([0, 0], [game.size, -game.size]),
            midPoint([0, -game.size], [game.size, -game.size * 2]),
            midPoint([0, -game.size * 2], [game.size, -game.size * 3]),
            midPoint([0, -game.size * 3], [game.size, -game.size * 4]),
    ...
    "Forma6": {
        ...
        points: [
            ...
            midPoint([0, -game.size * 2], [game.size, -game.size * 2]),
            midPoint([game.size, -game.size], [game.size, -game.size * 2]),
            midPoint([game.size * 2, -game.size], [game.size * 2, -game.size * 2]),
            midPoint([game.size * 2, -game.size], [game.size * 3, -game.size]),
            midPoint([game.size * 2, -game.size * 2], [game.size * 3, -game.size * 2]),
            midPoint([game.size * 3, -game.size * 3], [game.size * 4, -game.size * 3]),
            midPoint([game.size * 3, -game.size * 2], [game.size * 3, -game.size * 3]),
            midPoint([0, 0], [game.size, -game.size]),
            midPoint([0, -game.size], [game.size, -game.size * 2]),
            midPoint([0, -game.size * 2], [game.size, -game.size * 3]),
            midPoint([game.size, -game.size], [game.size * 2, -game.size * 2]),
            midPoint([game.size * 2, 0], [game.size * 3, -game.size]),
            midPoint([game.size * 2, -game.size], [game.size * 3, -game.size * 2]),
            midPoint([game.size * 2, -game.size * 2], [game.size * 3, -game.size * 3]),
            midPoint([game.size * 3, -game.size * 2], [game.size * 4, -game.size * 3]),
            midPoint([game.size * 3, -game.size * 3], [game.size * 4, -game.size * 4])
        ],
        visible: true
    }
}