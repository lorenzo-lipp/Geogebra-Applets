...
class Game {
    ...
    nextStep() {
        ...
        if (solutionStep === 0) {
            ...
            ggbApplet.setTextValue("text17", `${num1} \\times ${num2} = ?                  ${den1} \\times ${den2} = ?`);
        } else if (solutionStep === 2) {
            ggbApplet.setTextValue("text17", `${num1} \\times ${num2} = ${num1 * num2}                  ${den1} \\times ${den2} = ${den1 * den2}`);
        } else {
            ggbApplet.setTextValue("text20", `\\frac{${num1}}{${den1}} ${this.gameType === 1 ? "\\times" : "\\div"} \\frac{${num2}}{${den2}} = \\frac{${num1 * num2}}{${den1 * den2}}`);
        }
